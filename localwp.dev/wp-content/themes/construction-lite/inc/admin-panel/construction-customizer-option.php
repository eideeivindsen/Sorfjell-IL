...
$wp_customize->add_control(
    'construction_lite_skin_color',
    array(
        'label' => __('Choose Template Color','construction-lite'),
        'priority' => 8,
        'type' => 'radio',
        'choices' => array(
            '' => __('Default','construction-lite'),
            '#E9967A' => __('DarkSalmon','construction-lite'),
            '#800000' => __('Maroon','construction-lite'),
            '#00a0d2' => __('Tomato','construction-lite'),
        ),
