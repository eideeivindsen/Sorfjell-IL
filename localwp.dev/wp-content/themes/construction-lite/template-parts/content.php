...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			<div class="comment-author-date">
                ...
                <span class="post-comment"><a href="<?php comments_link(); ?>"><i class="fa fa-comment-o" aria-hidden="true"></i><?php printf( _nx( '1 Comment', '%1$s Comments', get_comments_number(), 'comments title', 'construction-lite' ), number_format_i18n( get_comments_number() ) ); ?></a></span>
            </div>
		</div><!-- .entry-meta -->
		<?php
		endif; ?>
	...
	<div class="entry-content">
        ...
        if ( is_single() ) :
            ...
            ?>
                <a class="read-more" href="<?php the_permalink() ?>"><?php _e('Read More','construction-lite'); ?><i class="fa fa-angle-right " aria-hidden="true"></i></a>
            <?php
        endif;
			wp_link_pages( array(
