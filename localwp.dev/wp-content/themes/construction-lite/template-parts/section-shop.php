                    ...
                    <div class="product-info-wrap <?php if (empty($average)){echo 'no-rating';} ?>">
                        ...
                        <div class="rating-price clearfix">
                            ...
                            <div class="product-rating">
                                <?php if ($average) : ?>
                                    <?php echo '<div class="star-rating" title="'.sprintf(__( 'Rated %s out of 5', 'construction-lite' ), $average).'"><span style="width:'.( ( $average / 5 ) * 100 ) . '%"><strong itemprop="ratingValue" class="rating">'.$average.'</strong> '.__( 'out of 5', 'construction-lite' ).'</span></div>'; ?>
                                <?php endif; ?>
                            </div>
                        </div>
